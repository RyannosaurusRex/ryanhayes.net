    ...
    <div className="lg:pr-8">
      <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
        ...
        <form action="#" method="POST" name="contact" data-netlify="true" data-netlify-honeypot="bot-field" className="mt-9 grid grid-cols-1 row-gap-6 sm:grid-cols-2 sm:col-gap-8">
          ...
          <div className="mb-4">
            <label className="block text-lg font-extrabold font-medium leading-5 text-gray-700">Name</label>
            <div className="border-2 border-gray-500 mt-1 relative rounded-md shadow-sm">
              <input id="name" className="form-input block w-full transition ease-in-out duration-150 sm:text-sm sm:leading-5" />
            </div>
          </div>
          <div className="sm:col-span-2 mb-4">
            <label className="block text-lg font-extrabold font-medium leading-5 text-gray-700">Email</label>
            <div className="border-2 border-gray-500 mt-1 relative rounded-md shadow-sm">
          ...
          <div className="sm:col-span-2 mb-4">
            <div className="flex justify-between">
              <label className="block text-lg font-extrabold font-medium leading-5 text-gray-700">How can I help you?</label>
